...
pub fn write_styled_and_wrapped<W: Write, S: AsRef<str>>(
    ...
    let words: Vec<_> = textwrap::word_separators::UnicodeBreakProperties
    ...
    match words.first() {
        ...
        Some(first_word) => {
            ...
            let widths = [
                ...
                max_width - current_width.min(max_width),
...
pub fn write_start_heading<W: Write>(
    ...
    StackedState::Inline(InlineState::InlineBlock, InlineAttrs { style, indent: 0 })
}
